...
public class SelectContactActivity extends Activity {
	...
	//	contactListView = (ListView)findViewById(R.id.contactsListView);
		...
		//			contactListView.setAdapter(null);
			...
			//		contactListView.setAdapter(new ContactListViewAdapter(content,SelectContactActivity.this));
				}
			}
	...
	public void suggest(View view) {
		...
		r = new RestService(mHandlerP,this,"http://jigar-btp.cloudapp.net/suggest_service/",RestService.POST);
	...
	private SpinnerEntry queryDetailsForContactSpinnerEntry(int contactId) {
		...
		final Cursor contact = managedQuery(
				...
				projection,
				BaseColumns._ID + "=?",						// filter entries on the basis of the contact id
